...
from .conv import Conv, DWConv, GhostConv, LightConv, RepConv, autopad, DConv, DCNv3_PyTorch, Conv_simam, DConv_with_ca
...
class Bottleneck_DCNV3(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):  # ch_in, ch_out, shortcut, groups, kernels, expand
        super().__init__()
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = DCNv3_PyTorch(c_, c2, k[1], 1, groups=g)
        # self.cv1 = DConv(c1, c_, k[0], 1)
